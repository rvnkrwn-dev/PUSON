<template>
  <div class="h-screen w-screen bg-gray-50 flex flex-col items-center justify-center">
          ...
          <div class="mt-8">
            ...
            <form>
              <div class="grid gap-y-4">
                ...
                <div>
                  <div class="flex justify-between items-center">
                    <label for="confirm_password" class="block text-sm mb-2">Ulangi Kata sandi</label>
                  </div>
                  <div class="relative">
                    <input type="password" id="confirm_password" name="confirm_password" class="py-3 px-4 block w-full border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" required aria-describedby="password-error">
                    <div class="hidden absolute inset-y-0 end-0 pointer-events-none pe-3">
                      <svg class="size-5 text-red-500" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
                        <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
                      </svg>
                ...
                <div class="flex items-center">
                  ...
                  <div class="ms-3">
                    <label for="remember-me" class="text-sm">
                      Saya menerima <NuxtLink to="#" class="text-blue-500 font-semibold">Syarat dan Ketentuan</NuxtLink>
                    </label>
                  </div>
                </div>
                <!-- End Checkbox -->

                <button type="submit" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">Daftar</button>
              </div>
            </form>
            <!-- End Form -->
