    ...
    <div class="relative h-screen overflow-y-auto">
      <div class="max-w-4xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="text-center">
          <a class="inline-block mb-4 flex-none focus:outline-none focus:opacity-80"
             href="../examples/html/ai-with-sidebar.html" aria-label="Preline">
            <svg class="w-28 h-auto mx-auto" width="116" height="32" viewBox="0 0 116 32" fill="none"
              ...
              <path
                  ...
                  class="stroke-blue-600" stroke="currentColor" stroke-width="2"/>
              <circle cx="13" cy="16" r="5" fill="currentColor" class="fill-blue-600"/>
            </svg>
          </a>
        ...
        <ul class="mt-16 space-y-5">
            ...
            <div class="grow max-w-[90%] md:max-w-2xl w-full space-y-3">
              ...
              <div>
                <div class="sm:flex sm:justify-between">
                  <div>
                    <div class="inline-flex border border-gray-200 rounded-full p-0.5">
                      <button type="button"
                              class="inline-flex shrink-0 justify-center items-center size-8 rounded-full text-gray-500 hover:bg-blue-100 hover:text-blue-800 focus:z-10 focus:outline-none focus:bg-blue-100 focus:text-blue-800">
                    ...
                    <button type="button"
                            class="py-2 px-3 inline-flex items-center gap-x-2 text-sm rounded-full border border-transparent text-gray-500 hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none">
                      <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
          ...
          <li class="flex gap-x-2 sm:gap-x-4">
            ...
            <div class="grow max-w-[90%] md:max-w-2xl w-full space-y-3">
              ...
              <div class="bg-white border border-gray-200 rounded-lg p-4 space-y-3">
                <p class="text-sm text-gray-800">
                  Preline UI Figma is the largest free design system for Figma, crafted with Tailwind CSS styles and
                  Preline
                  UI components with extra top-notch additions.
                </p>
                <div class="space-y-1.5">
                  <p class="text-sm text-gray-800">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                          ...
                          <div class="px-6 py-3">
                            <div class="flex items-center gap-x-3">
                              ...
                              <div class="flex w-full h-1.5 bg-gray-200 rounded-full overflow-hidden" role="progressbar"
                                ...
                                <div
                                    class="flex flex-col justify-center overflow-hidden bg-gray-800 text-xs text-white text-center whitespace-nowrap"
                                    style="width: 25%"></div>
                              </div>
                            </div>
                          </div>
                      ...
                      <tr>
                        ...
                        <td class="size-px whitespace-nowrap">
                          <div class="px-6 py-3">
                          <span
                              class="inline-flex items-center gap-1.5 py-0.5 px-2 rounded-full text-xs font-medium bg-orange-100 text-orange-800">
                            <svg class="size-2.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                 fill="currentColor" viewBox="0 0 16 16">
                              <path
                      ...
                      <tr>
                        <td class="size-px whitespace-nowrap">
                          <div class="px-6 py-3">
                            <div class="flex items-center gap-x-3">
                            <span class="inline-flex items-center justify-center size-[38px] rounded-full bg-gray-300">
                              <span class="font-medium text-gray-800 leading-none">A</span>
                            </span>
                              <div class="grow">
          ...
          <li class="flex gap-x-2 sm:gap-x-4">
            ...
            <div class="grow max-w-[90%] md:max-w-2xl w-full space-y-3">
              ...
              <div class="mt-3 flex-none min-w-full bg-gray-800 font-mono text-sm p-5 rounded-lg"><span
                  class="text-red-500"><</span><span class="text-red-500">table <span class="text-gray-300">class="<span
                  class="text-sky-400">min-w-full divide-y divide-gray-200"</span><span
                  class="text-red-500">></span><span
                  class="block"></span>  <span class="ms-5 text-red-500"><</span><span class="text-red-500">thead <span
                  class="text-gray-300">class="<span class="text-sky-400">bg-gray-50"</span><span
                  class="text-red-500">></span><span class="block"></span><span class="text-red-500">    <span
                  class="ms-10 text-gray-500">...</span></span></span></span></span></span></div>
          ...
          <li class="flex gap-x-2 sm:gap-x-4">
            ...
            <div class="grow max-w-[90%] md:max-w-2xl w-full space-y-3">
              ...
              <div>
                <button type="button"
                        class="mb-2.5 me-1.5 py-2 px-3 inline-flex justify-center items-center gap-x-2 rounded-lg border border-blue-600 bg-white text-blue-600 align-middle hover:bg-blue-50 focus:outline-none focus:bg-blue-50 text-sm">
          ...
          <li class="flex gap-x-2 sm:gap-x-4">
            ...
            <div class="grow max-w-[90%] md:max-w-2xl w-full space-y-3">
              ...
              <div class="bg-white border border-gray-200 rounded-lg p-4 space-y-3">
                <p class="text-sm text-gray-800">
                  Tailwind CSS is an open source CSS framework. The main feature of this library is that, unlike other
                  CSS
                  frameworks like Bootstrap, it does not provide a series of predefined classes for elements such as
                  buttons
                  or tables.
                </p>
                <div class="space-y-1.5">
          ...
          <li class="max-w-2xl ms-auto flex justify-end gap-x-2 sm:gap-x-4">
            <div>
              <div class="text-end">
                <button type="button"
                        class="mb-2.5 ms-1.5 py-2 px-3 inline-flex justify-center items-center gap-x-2 rounded-lg border border-blue-600 bg-white text-blue-600 align-middle hover:bg-blue-50 focus:outline-none focus:bg-blue-50 text-sm">
          ...
          <li class="max-w-2xl ms-auto flex justify-end gap-x-2 sm:gap-x-4">
            <div class="grow text-end space-y-3">
              ...
              <ul class="flex flex-col justify-end text-start -space-y-px">
                <li class="flex items-center gap-x-2 p-3 text-sm bg-white border text-gray-800 first:rounded-t-lg first:mt-0 last:rounded-b-lg">
                  <div class="w-full flex justify-between truncate">
                <span class="me-3 flex-1 w-0 truncate">
                  resume_web_ui_developer.csv
                </span>
                    <button type="button"
                            class="flex items-center gap-x-2 text-gray-500 hover:text-blue-600 focus:outline-none focus:text-blue-600 whitespace-nowrap">
                      <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                           viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                           stroke-linejoin="round">
