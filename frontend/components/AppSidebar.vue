  ...
  <div id="hs-application-sidebar" class="hs-overlay  [--auto-close:lg]
    ...
    <div class="relative flex flex-col h-full max-h-full">
      ...
      <div
        ...
        <nav class="hs-accordion-group p-3 h-full w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
          <ul class="h-full flex flex-col space-y-1 relative">
            <li>
            ...
            <li class="absolute bottom-6 w-full"><NuxtLink
                active-class="bg-gray-100"
                class="cursor-pointer w-full flex items-center justify-center bg-red-500 text-white gap-x-2 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-red-700"
                @click="handleLogout">
